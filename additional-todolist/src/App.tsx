...
function App() {
    ...
    function removeTask(todolistId: string, taskId: string) {
        ...
        //const newTask = tasks[todolistId].data.filter(el => el.id !== taskId)
        //setTasks({...tasks, [todolistId]:{data: newTask, filter: 'all'}})

        //setTasks({...tasks, [todolistId]: tasks[todolistId].data.filter(el => el.id !== taskId)})
